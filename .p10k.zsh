# Generated by Powerlevel10k configuration wizard on 2023-12-15 at 04:23 EST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 8860.
# Wizard options: compatible, unicode, lean, 2 lines, dotted, no frame, dark-ornaments,
# sparse, concise, instant_prompt=verbose.
...
() {
  ...
  # My Custom Path Configuration for Powerlevel10k
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=40
  ...
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_ICON='🍜'  # cooking something up!
  typeset -g POWERLEVEL9K_VCS_STAGED_ICON='📸'    # ready for a snapshot/commit!
  typeset -g POWERLEVEL9K_VCS_COMMITS_AHEAD_ICON='🚀'     # ready to ship to remote!
  typeset -g POWERLEVEL9K_VCS_COMMITS_BEHIND_ICON='🚢'    # ready to receive from remote!
